...
// TestDynamoMetaStore_MixedBatchInvalidSuffixDoesNotStrandPrefix verifies that
...
func TestDynamoMetaStore_MixedBatchInvalidSuffixDoesNotStrandPrefix(t *testing.T) {
	ctx := context.Background()
	ms := dynamoTestStore(t)
